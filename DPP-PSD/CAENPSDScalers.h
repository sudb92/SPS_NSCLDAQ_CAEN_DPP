...
*
*/
#ifndef CAENPSDSCALERS_H
#define CAENPSDSCALERS_H
#include <CScaler.h>
 ...
 *   uint32_t word.
 */
class CAENPSDScalers : public CScaler
{
private:
    CDPpPsdEventSegment*     m_pSegment;
    int                   m_nSourceId;
public:
    CAENPSDScalers(CDPpPsdEventSegment* pEventSegment, int srcid = 0);
