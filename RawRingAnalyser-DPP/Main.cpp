...
/**
    ...
    -  Use whatever input methods you have to absorb ring items from the data
       source.
    -  Feed those ring items to a CDPPRingItemDecoder class instance (see CDPPRingItemDecoder.{h.cpp}).
    ...
    -  Register the the fragment handlers you need with the CDPPRingItemDecoder
...
#include "CDPPRingItemDecoder.h"              // Sample code.
...
main(int argc, char**argv)
{
    ...
    //decoder.openROOTFile("directory","filename.root");
